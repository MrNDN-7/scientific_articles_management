...
public class P_TaiKhoanModel {
	...
	public P_TaiKhoanModel(String emailgvall) {
		super();
	...
	public P_TaiKhoanModel(String maTK, String username, String password, String role, String trangthai, String maPQl,
