...
public class P_ThongBaoModel {
	...
	public P_ThongBaoModel(String magvall) {
		super();
	...
	public P_ThongBaoModel(String nguoiNhan, String tieuDeGui, String noiDungGui, String nguoiGui) {
		super();
		NguoiNhan = nguoiNhan;
		TieuDeGui = tieuDeGui;
	...
	public P_ThongBaoModel(String maGV, String tenGV) {
		super();
		MaGV = maGV;
		TenGV = tenGV;
	}
	...
	public P_ThongBaoModel(String tieuDe, String noiDung, String nguoiGui, LocalDate ngayGui) {
		super();
		TieuDe = tieuDe;
		NoiDung = noiDung;
		NguoiGui = nguoiGui;
